  ...
  return (
    <div className="px-4 flex justify-center items-center">
      <div className="contaier mx-auto">
        ...
        <div className="mt-[138px] max-lg:mt-[128px] max-sm:mt-[88px] flex max-lg:max-w-[774px] max-lg:gap-y-[88px] justify-center max-xl:justify-start max-[833px]:justify-center mx-auto max-lg:flex-wrap gap-[20px] max-lg:gap-9">
